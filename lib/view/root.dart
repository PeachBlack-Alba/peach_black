...
import 'package:peach_black/view/widget/rightPane.dart';
import 'package:peach_black/view/work/work.dart';
        ...
        Expanded(
            ...
            child: Consumer(builder: (context, ref, child) {
              ...
              return ListView(
                ...
                children: [
                  AutoScrollTag(key: ValueKey(0), controller: mScrollController, index: 0, child: Intro()),
